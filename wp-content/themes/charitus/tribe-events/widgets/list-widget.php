...
if ( $posts ) : ?>
	...
	<p class="tribe-events-widget-link">
		<a class="btn btn-fill" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'View All %s', 'charitus' ), $events_label_plural ); ?></a>
	</p>

<?php
// No events were found.
else : ?>
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'charitus' ), $events_label_plural_lowercase ); ?></p>
<?php
endif;

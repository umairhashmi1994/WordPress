 ...
 * @var $xt_vc_progress_bar_primary
 */
$title = $values = $units = $bgcolor = $css = $custombgcolor = $customtxtcolor = $options = $el_class = $css_animation = $xt_vc_progress_bar_primary = '';
$output = '';
...
if( $xt_vc_progress_bar_primary == 'on' ){
	$class_to_filter .= ' xt_vc_progress_bar'; 
}

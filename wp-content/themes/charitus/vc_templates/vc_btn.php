...
$a_href = $a_title = $a_target = $a_rel = $xt_vc_btn_theme_primary = '';
$styles = array();
$icon_wrapper = false;
$icon_html = false;
$attributes = array();
...
if( $xt_vc_btn_theme_primary == 'on' ){
	$button_classes = array();
	$button_classes[] = 'xt-vc-theme-btn-primary btn btn-fill';
	$button_classes[] = 'btn-'.$size;
	$wrapper_classes[] = 'xt-vc-theme-btn-primary-container';
}else{
	$button_classes = array(
		'vc_general',
		'vc_btn3',

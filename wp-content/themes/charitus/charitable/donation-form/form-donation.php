...
<form method="post" id="<?php echo esc_attr( $form_id ) ?>" class="charitable-donation-form charitable-form" data-use-ajax="<?php echo esc_attr( $use_ajax ) ?>">
	...
	<div class="charitable-form-field charitable-submit-field">
		<button class="button button-primary btn btn-fill btn-lg btn btn-fill" type="submit" name="donate"><?php esc_html_e( 'Donate', 'charitus' ) ?></button>
		<div class="charitable-form-processing" style="display: none;">
			<img src="<?php echo esc_url( charitable()->get_path( 'assets', false ) ) ?>/images/charitable-loading.gif" width="60" height="60" alt="<?php esc_attr_e( 'Loading&hellip;', 'charitus' ) ?>" />
		</div>
	</div>
</form>
